...
def transfer(args):
    ...
    if DATASET == 'MNIST':
        ...
        test_loader = DataLoader(testset_1, batch_size=config.training.batch_size, shuffle=True, num_workers=1,
        ...
        if generateLangevinSamples == False:
            ...
            pickle.dump(loss_track,
                        open('cifar_TransferCDSM_Size' + str(SUBSET_SIZE) + "_Seed" + str(SEED) + '.p', 'wb'))
        else:
            pass
