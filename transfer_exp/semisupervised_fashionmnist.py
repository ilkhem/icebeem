...
def semisupervised_fmnist():
    ...
    labels -= 8
    rep_train, rep_test, lab_train, lab_test = train_test_split((representations), labels, test_size=test_size,
                                                                random_state=0)
    ...
    labels_base -= 8
    rep_train_b, rep_test_b, lab_train_b, lab_test_b = train_test_split((representations_base), labels_base,
